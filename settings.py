...
# A section for common usage - might be better off first so it is the default (Red)
...
#And one that would be useful in a browser (Yellow)
modes[4] = Mode("Browser", "#FFFF00")
modes[4].keyPress(1, Keycode.SPACE)
modes[4].keyPress(2, Keycode.TAB)
modes[4].keyPress(3, (Keycode.SHIFT, Keycode.TAB))
modes[4].keyPress(4, Keycode.PAGE_DOWN)